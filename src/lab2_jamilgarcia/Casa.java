...
public class Casa {
    ...
    public String toString() {
        return "Casa{" + "n_casa=" + n_casa + ", n_bloque=" + n_bloque + ", color=" + color + ", ancho=" + ancho + ", largo=" + largo + ", comprada=" + comprada + ", pisos=" + pisos + ", banos=" + banos + ", cuartos=" + cuartos + ", due\u00f1o=" + dueño + ", ingeniero=" + ingeniero + '}';
    }
